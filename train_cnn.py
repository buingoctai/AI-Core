...
# Data loading params
tf.flags.DEFINE_float("dev_sample_percentage", .3,
                      "Percentage of the training data to use for validation")
tf.flags.DEFINE_string("find_data_file", "./Data_Training_CNN/Data.findRestaurantsByCity",
                       "Data source for the findRestaurantsByCity data.")
tf.flags.DEFINE_string(
    "greet_data_file", "./Data_Training_CNN/Data.greet", "Data source for the greet data.")
tf.flags.DEFINE_string(
    "bye_data_file", "./Data_Training_CNN/Data.bye", "Data source for the bye data.")
tf.flags.DEFINE_string("affirmative_data_file", "./Data_Training_CNN/Data.affirmative",
                       "Data source for the affirmative data.")
tf.flags.DEFINE_string("negative_data_file", "./Data_Training_CNN/Data.negative",
...
tf.flags.DEFINE_integer(
    "num_filters", 8, "Number of filters per filter size (default: 128)")
...
tf.flags.DEFINE_integer(
    "evaluate_every", 28, "Evaluate model on dev set after this many steps (default: 100)")
tf.flags.DEFINE_integer("checkpoint_every", 28,
...
def preprocess():
    ...
    # Load data: output decription: x_text array (each element is one example), y array(label for every item in x_text array)
    print("Loading data...")
    ...
    # Build vocabulary: use VocabularyProcessor in tensoflow
    # --------------------Intructions--------------------------------
    #
    ...
    print("----------------------------------")
    print("vocab_processor object=", vocab_processor)
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(
                os.path.curdir, "run_cnn", timestamp))
            print("Writing to {}\n".format(out_dir))
            ...
            plt.plot(eval_indices, train_acc1, 'k-',
